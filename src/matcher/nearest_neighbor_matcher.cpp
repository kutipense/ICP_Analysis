...
namespace matcher {
NearestNeighborMatcher::NearestNeighborMatcher(const VertexList::Vector& source_data,
                                               const VertexList::Vector& target_data, int number_of_checks,
                                               float max_distance, int tree_size)
    : Matcher(source_data, target_data),
      num_of_checks_(number_of_checks),
      max_distance_(max_distance),
      tree_size_(tree_size) {}

MatchList::Ptr NearestNeighborMatcher::match() {
